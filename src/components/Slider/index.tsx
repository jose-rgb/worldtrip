    ...
    return (
        <Flex w="100%" maxW="1240px" mx="auto" mb={["5", "10"]} h={["250px", "450px"]} >
            ...
            <Swiper modules={[Navigation, Pagination]} slidesPerView={1} navigation pagination={{clickable: true}} autoplay={{delay: 4000,}} style={{width: '100%', flex: '1'}} >
                ...
                <SwiperSlide>
                    <Flex w="100%" h="100%" align="center" justify="center" direction="column" bgImage="url(/slide/australia.jpeg)" bgRepeat="no-repeat" bgSize="cover" textAlign="center" bgPosition="center" > 

                        <Link href="/continent/oceania" >
                            <a>
                                <Heading fontSize={["3xl", "4xl", "5xl"]} color="gray.100" fontWeight="bold" >Oceania</Heading>
                                <Text fontWeight="bold" color="gray.50" fontSize={["0.8rem", "1xl", "2xl"]} mt={["2", "4"]} >Paraíso tropical.</Text>
                            </a>
                        </Link>
